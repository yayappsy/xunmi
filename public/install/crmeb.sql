...
(32, 'store_free_postage', 'text', 'input', 5, '', 0, 'number:true,min:-1', 100, 0, '"1000"', '满额包邮', '商城商品满多少金额即可包邮', 0, 1),
...
(45, 'site_store_admin_uids', 'text', 'input', 5, '', 0, '', 100, 0, '"4"', '管理员用户ID', '管理员用户ID,用于接收商城订单提醒，到微信用户中查找编号，多个英文‘,’隔开', 0, 2),
...
(144, 'cache_config', 'text', 'input', 19, NULL, NULL, '', '100', NULL, '\"86400\"', '网站缓存时间', '配置全局缓存时间（秒），默认留空为永久缓存', '0', '1'),
...
(16, '首页配置', 'routine_index_page', 1, 1, 'home', 0),
(17, '文件上传配置', 'upload_set', 1, 0, 'cloud-upload', 0),
(18, '短信配置', 'system_sms', 1, 0, 'send', 3),
(19,'缓存配置','cache_config', 1, 0, 'cube', 0),
(20,'短信提醒开关', 'short_letter_switch', '1', '0', 'rss', '0'),
(21,'小票打印配置', 'printing_deploy', '1', '0', 'plug', '0');
...
(176, 54, '{\"name\":{\"type\":\"input\",\"value\":\"\\u8ba2\\u5355\\u6838\\u9500\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/kaifa.crmeb.net\\/uploads\\/attach\\/2019\\/10\\/20191011\\/e5eab1a735b58f171cfd507cb849e96b.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/pages\\/service\\/index\"},\"wap_url\":{\"type\":\"select\",\"value\":\"\\/order\\/order_cancellation\"}}', '1569382895', '1', '1');
