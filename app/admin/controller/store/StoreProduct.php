    ...
    public function get_product_info($id = 0)
    {
        ...
        if ($id) {
            ...
            if ($productInfo['spec_type'] == 1) {
                ...
                $productInfo['attrs'] = [];
                $productInfo['attr'] = [
                    'pic' => $single['pic'] ?? $productInfo['image'],
                    'price' => $single['price'] ?? $productInfo['price'],
                    'cost' => $single['cost'] ?? $productInfo['cost'],
                    'ot_price' => $single['ot_price'] ?? $productInfo['ot_price'],
                    'stock' => $single['stock'] ?? $productInfo['stock'],
