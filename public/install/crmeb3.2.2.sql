...
CREATE TABLE `eb_store_visit`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品浏览分析表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of eb_store_visit
-- ----------------------------
INSERT INTO `eb_store_visit` VALUES (1, 3, NULL, 3, 'viwe', 0, 1, '', 1586779158);
...
-- ----------------------------
INSERT INTO `eb_system_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', '1', '127.0.0.1', 1586780712, 0, 0, 0, 1, 0);
...
CREATE TABLE `eb_system_log`  (
  ...
  INDEX `add_time`(`add_time`) USING BTREE,
  INDEX `type`(`type`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '管理员操作记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of eb_system_log
-- ----------------------------
INSERT INTO `eb_system_log` VALUES (29, 1, 'admin', 'admin/setting.systemconfig/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780730, 0);
INSERT INTO `eb_system_log` VALUES (30, 1, 'admin', 'admin/setting.systemconfig/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780738, 0);
INSERT INTO `eb_system_log` VALUES (31, 1, 'admin', 'admin/setting.systemconfig/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780750, 0);
INSERT INTO `eb_system_log` VALUES (32, 1, 'admin', 'admin/setting.systemconfig/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780759, 0);
INSERT INTO `eb_system_log` VALUES (33, 1, 'admin', 'admin/setting.systemconfig/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780854, 0);
INSERT INTO `eb_system_log` VALUES (34, 1, 'admin', 'admin/setting.systemconfig/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780858, 0);
INSERT INTO `eb_system_log` VALUES (35, 1, 'admin', 'admin/setting.systemconfig/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780863, 0);
INSERT INTO `eb_system_log` VALUES (36, 1, 'admin', 'admin/system.systemupgradeclient/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780924, 0);
INSERT INTO `eb_system_log` VALUES (37, 1, 'admin', 'admin/system.systemupgradeclient/get_list/', '未知', 'admin', '127.0.0.1', 'system', 1586780929, 0);
INSERT INTO `eb_system_log` VALUES (38, 1, 'admin', 'admin/system.systemupgradeclient/get_new_version_conte/', '未知', 'admin', '127.0.0.1', 'system', 1586780929, 0);
INSERT INTO `eb_system_log` VALUES (39, 1, 'admin', 'admin/setting.systemconfigtab/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780942, 0);
INSERT INTO `eb_system_log` VALUES (40, 1, 'admin', 'admin/setting.systemgroup/index/', '未知', 'admin', '127.0.0.1', 'system', 1586780956, 0);
INSERT INTO `eb_system_log` VALUES (41, 1, 'admin', 'admin/routine.routinetemplate/index/', '未知', 'admin', '127.0.0.1', 'system', 1586781080, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信模板' ROW_FORMAT = Dynamic;
